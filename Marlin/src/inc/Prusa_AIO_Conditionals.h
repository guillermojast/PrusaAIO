...
// Default Extruder inverting
  ...
  #define PRUSA_AIO_E0_MICROSTEPS            32
    ...
    #define PRUSA_AIO_CHOPPER_TIMING_E CHOPPER_DEFAULT_24V // WAS CHOPPER_DEFAULT_24V
  #endif
...
// User Extruder inverting
  ...
  #if DISABLED(PRUSA_AIO_MK25S_SUPPORT)
    #define PRUSA_AIO_CHOPPER_TIMING_X CHOPPER_DEFAULT_24V // WAS CHOPPER_DEFAULT_24V
    #define PRUSA_AIO_CHOPPER_TIMING_Y CHOPPER_DEFAULT_24V // WAS CHOPPER_DEFAULT_24V
    #define PRUSA_AIO_CHOPPER_TIMING_Z CHOPPER_DEFAULT_24V // WAS CHOPPER_DEFAULT_24V
  #endif
...
//===========================================================================
  ...
  #define PIDTEMP
    ...
    #else
      #define PRUSA_AIO_DEFAULT_Kp  23.30 // 16.50
      #define PRUSA_AIO_DEFAULT_Ki   2.52 //  1.16
      #define PRUSA_AIO_DEFAULT_Kd  53.79 // 58.80
    #endif
  #endif
#endif
